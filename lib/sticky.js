...
var windowEvents = ['resize', 'scroll', 'touchstart', 'touchmove', 'touchend', 'pageshow', 'load'];

var containerEvents = ['resize', 'scroll'];
  ...
  _createClass(Sticky, [{
    ...
    value: function on(target, events, callback) {
      events.forEach(function (evt) {
        return target.addEventListener(evt, callback);
      });
    }
  }, {
    key: 'off',
    value: function off(target, events, callback) {
      events.forEach(function (evt) {
        return target.removeEventListener(evt, callback);
      });
    }
  }, {
...
Sticky.propTypes = {
  containerElement: _react2.default.PropTypes.string,
  placeholderElement: _react2.default.PropTypes.string,
  childrenElement: _react2.default.PropTypes.string,
